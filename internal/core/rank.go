...
// Ready for redesign outranks Ready for design for the same reason: a
// bounced design reached the record review once, and the design
// dispatcher walks tickets in this order, so a redesign goes before a
// fresh design the way rework goes before fresh dev. Blocked, Done and
// Canceled never compete for dispatch, so their rank is irrelevant; they
// get 0.
